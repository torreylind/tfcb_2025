...
Download the course files with the following link: [github.com/FredHutch/tfcb_2025/archive/refs/heads/main.zip](https://github.com/FredHutch/tfcb_2025/archive/refs/heads/main.zip). Copy the contents of `homeworks/homework01/messy-project-directory/` to a new directory on your computer named `tfcb-homework01`.
...
(https://github.com/torreylind/tfcb-homework01/blob/main/README.md)
...
[_Include the link to your `.csv` file on GitHub here._](https://github.com/torreylind/tfcb-homework01/blob/main/Data/survey_data_tidy.txt)
